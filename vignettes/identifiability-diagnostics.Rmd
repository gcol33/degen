...
```{r plot-eigenvalues, fig.alt="Bar chart showing eigenvalue spectrum of the Fisher information matrix. One eigenvalue is positive indicating an identifiable direction, while the other is near zero indicating a non-identifiable direction (the null space)."}
plot(info)
```
...
- `vignette("comparing-models")` - Model equivalence testing
