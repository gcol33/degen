...
Non-Identifiability in Models*. R package version 0.1.0,
<https://github.com/gcol33/degen>.

    @Manual{,
      title = {degen: Detect Observational Equivalence and Non-Identifiability in Models},
